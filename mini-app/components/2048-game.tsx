  ...
  return (
    <div className="flex flex-col items-center gap-4">
      <div className="relative">
        ...
        <div className="absolute -bottom-5 left-1/2 transform -translate-x-1/2 text-4xl">🌷</div>
        <div className="absolute top-1/2 -left-5 transform -translate-y-1/2 text-4xl">🌻</div>
        <div className="absolute top-1/2 -right-5 transform -translate-y-1/2 text-4xl">🌸</div>
        <div className="absolute -top-5 left-1/2 transform -translate-x-1/2 text-4xl">🌻</div>
        <div className="absolute -bottom-5 left-1/2 transform -translate-x-1/2 text-4xl">🌸</div>
        <div className="absolute top-1/2 -left-5 transform -translate-y-1/2 text-4xl">🌺</div>
        <div className="absolute top-1/2 -right-5 transform -translate-y-1/2 text-4xl">🌼</div>
